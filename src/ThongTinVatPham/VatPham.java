...
public class VatPham {
    ...
    public void xuat() {
        System.out.println("----------------");
        System.out.println("-- Ten: " + checkVatPham() + "-- Chi so suc manh: " + chiSoSucManh + " -- He so suc manh: "
                + heSoSucManh + "-- Suc cong pha: " + tinhSucCongPha() + "-- So vang (quy doi/1 suc cong pha): "
                + tongSoVangQuyDoi());
        ...
        // System.out.println("-- So vang (quy doi/1 suc cong pha): " +
        // tongSoVangQuyDoi());
    }
